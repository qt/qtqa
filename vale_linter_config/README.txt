...
1. Install Vale:
   ...
   - To lint QDoc sources (.qdoc, .qdocinc, .qml, .cpp), download
     the patched Vale binary with QDoc parser support from
     https://github.com/veshivas/vale/releases/tag/v3.14.1-qdocsupport-alpha.
...
- .cpp, .h, .cc, .cxx    — only the /*!...*/ doc-comment blocks that
                            contain changed lines are linted.
