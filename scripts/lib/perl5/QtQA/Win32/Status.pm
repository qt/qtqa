...
sub AUTOLOAD
{
    my $symbol = $QtQA::Win32::Status::AUTOLOAD;
    return unless $symbol;

    # QtQA::Win32::Status::FOO -> FOO
...
QtQA::Win32::Status - convert Win32 status strings to integers and back
...
=head1 SYNOPSIS
  ...
  say $QtQA::Win32::Status::INTEGER_TO_SYMBOL{ 0xC0000417 };
  # ...prints STATUS_INVALID_CRUNTIME_PARAMETER

  # Or the other way around:
  printf "0x%0x\n", $QtQA::Win32::Status::SYMBOL_TO_INTEGER{ STATUS_INVALID_CRUNTIME_PARAMETER }

  # Or use the constants directly
  use QtQA::Win32::Status qw( STATUS_ACCESS_VIOLATION );
...
On request, the module will also directly export any named status constants:
  ...
  use QtQA::Win32::Status qw( STATUS_ACCESS_VIOLATION STATUS_INTEGER_OVERFLOW );
  # ... later:
