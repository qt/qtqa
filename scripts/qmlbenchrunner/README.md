...
Optional environment variables:
        ...
        TIMESCALEDBUSER=username #Set if writing to a database.
        TIMESCALEDBPASSWORD=password #Set if writing to a database.
...
**build_and_test.sh arguments are strictly positional. Do not skip arguments that are required.**
    ...
    Example:
        ...
        export TIMESCALEDBPASSWORD=dbuser1password
        export XAUTHORITY=/home/user1/.Xauthority
        export DISPLAY=:0
        qmlbenchrunner/build_and_test.sh 5.15 $NODE_NAME 8
...
real user desktop.
    ...
    Example:
        $env:TIMESCALEDBUSER=dbuser1
        $env:TIMESCALEDBPASSWORD=dbuser1password
        $env:BADTESTS=""
