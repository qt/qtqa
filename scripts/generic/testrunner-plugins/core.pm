...
# Maximum permitted size of core files (chosen arbitrarily)
Readonly my $CORE_LIMIT => 1024*1024*1024;

# Interface to /proc/sys values
tie my %SYSCTL, 'Tie::Sysctl';
...
sub new
{
    ...
    if ($OSNAME !~ m{linux}i) {
        croak 'sorry, core plugin is currently usable only on linux';
    }
