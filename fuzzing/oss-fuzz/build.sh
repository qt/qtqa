...
zip -j $WORK/images $SRC/qtqa/fuzzing/testcases/{bmp,gif,jpg,svg,xbm,xpm}/* $SRC/aflplusplus/testcases/images/*/*
...
build_fuzzer "qtbase" "corelib/text/qregularexpression/optimize/optimize.pro" "" "$SRC/aflplusplus/dictionaries/regexp.dict"
