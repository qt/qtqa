...
my %optionalFiles = (
    ...
    "qtbase"         => [
                          ...
                          # This is test data, of which some files have a .cpp extension
                          qr{^tests/auto/tools/qmake/testdata/},
                          # These test data files are generated by uic
                          qr{^tests/auto/tools/uic/baseline/.*\.h$},
                          # These test data files are secure certificates
                          qr{^tests/auto/network/ssl/qsslcertificate/more-certificates/},
