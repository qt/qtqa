...
my %excludedFiles = (
    ...
    'pyside-setup'   => [ qr{^examples/widgets/animation/easing/ui_form.py$},
                          ...
                          qr{^examples/widgets/dialogs/classwizard/classwizard_rc.py$},
                          qr{^examples/widgets/animation/easing/easing_rc.py$},
                          qr{^examples/widgets/animation/animatedtiles/animatedtiles_rc.py$},
                          qr{^examples/widgets/animation/states/states_rc.py$},
                          qr{^examples/widgets/animation/appchooser/appchooser_rc.py$},
                          qr{^examples/widgets/graphicsview/collidingmice/mice_rc.py$},
                          qr{^examples/widgets/graphicsview/dragdroprobot/dragdroprobot_rc.py$},
                          qr{^examples/widgets/graphicsview/diagramscene/diagramscene_rc.py$},
                          qr{^examples/widgets/mainwindows/mdi/mdi_rc.py$},
                          qr{^examples/widgets/mainwindows/dockwidgets/dockwidgets_rc.py$},
